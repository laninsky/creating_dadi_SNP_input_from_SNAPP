...
Using a tab-delimited file with your sample names in the left column, and your species/population designations in the right hand column (with outgroup species labelled as "outgroup", and your ingroup names capitalized), this script will create a SNP input file for dadi (pulling out one SNP per locus) using two slightly different implementations:
...
#Notes about namelist#

Capitalize your ingroup names, and use the lower case "outgroup" for your outgroups in order for the sort that the R-script does to end up with outgroup at the "bottom" for calculaitons.
